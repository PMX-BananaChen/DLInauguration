<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InaugurationDetail.aspx.cs" Inherits="DLInauguration.DL.InaugurationDetail" %>
        ...
        <div class="formbody">
            ...
            <div id="dlForm">
                ...
                <div>
                    <fieldset style="margin-left: 60px;">
                        ...
                        <table class="tbl">
                            ...
                            <tr>
                                <td style="text-align: left; width: 35%;">來源</td>
                                <td style="text-align: left; width: 65%;">&nbsp;</td>
                            </tr>
                        </table>
                    </fieldset>
                    ...
                    <fieldset style="margin-left: 60px;">
                        ...
                        <table style="width: 90%;margin-left:30px;line-height:30px;" border="0">
                            <tr style="border:0;">
                                ...
                                <td style="text-align: left; width: 20%; border: solid 1px #cbcbcb;">工號：<asp:Label ID="lblEmpNo" runat="server" Width="147px"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </fieldset>
                ...
                <div>
                    ...
                    <fieldset style="margin-left: 60px;">
                        <legend style="font-size: 15px;">宗教信仰</legend>
                        <table class="tablelist">
                            <tr>
                                <th>有无宗教信仰
                                </th>
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <asp:Label ID="lblIsReligiousBelief" runat="server" Text='<%#Eval("IsReligiousBelief")%>'></asp:Label>
                                </td>
                                <td style="width: 75%;">
                                    <asp:Label ID="lblReligiousBelief" runat="server" Text='<%#Eval("ReligiousBelief")%>'></asp:Label>
                                </td>
                            </tr>
                        </table>
                 ...
                 <%-- <div>
                    <fieldset style="margin-left: 60px;">
                        ...
                        <table class="tablelist">
                            <tr>
                                 <td   colspan="6"  class="auto-style22">请问您是如何得知本公司招聘信息的？
                                     <br />
                                     <asp:Label ID="lblXCGD" runat="server" Height="36px" Width="1124px"></asp:Label>
                                     <br />
                                     </td>
                            </tr>
                             <tr>
                                 <td   colspan="6"  class="auto-style22">请问您通过何种渠道应聘本公司的？
                                     <br />
                                     <asp:Label ID="lblYPXD" runat="server" Height="36px" Width="1124px"></asp:Label>
                                     <br />
                                     </td>
                            </tr>
