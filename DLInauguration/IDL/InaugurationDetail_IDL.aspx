        ...
        <div class="formbody">
            <div class="formtitle">
                ...
                <div style="float: right;">
                    ...
                    <a href="../IDL/InaugrationRecords_IDL.aspx">
            ...
            <div id="dlForm">
                ...
                <div>
                    <fieldset style="margin: 20px 0 20px 60px;">
                        <%--<table class="table">
                            <tr>
...
&nbsp;市場</td>
                                <td style="text-align: left; " class="auto-style8" rowspan="2">內部介紹</td>
                ...
                <div>
                    <fieldset style="margin: 20px 0 20px 60px;">
                        <%--<table class="table">
                            <tr>
                                <td class="auto-style23">中文姓名:</td>
                                <td class="auto-style18">
                                    <asp:Label ID="lblName" runat="server" Width="285px"></asp:Label></td>
                                <td class="auto-style23">英文姓名:</td>
                            ...
                            <tr>
                                <td class="auto-style23">出生日期:</td>
                                <td class="auto-style18">
                                    <asp:Label ID="lblBirthDay" runat="server"  Width="284px"></asp:Label></td>
                                   <td class="auto-style23">電&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;話:</td>
                                <td class="auto-style19">
                                    <asp:Label ID="lblPhoneNum" runat="server" Width="253px"></asp:Label></td>
                              
                            </tr>

                             <tr>
                                <td class="auto-style23">出生地点:</td>
                                <td class="auto-style18">
                                    <asp:Label ID="lblBornAddress" runat="server" Width="284px"></asp:Label></td>
                                <td class="auto-style23">手&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机:</td>
                                <td class="auto-style19">
                                   <asp:Label ID="lblPhoneNumber" runat="server" Width="300px"></asp:Label></td>
                            </tr>
                             <tr>
                                   <td class="auto-style23">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;別:</td>
                                <td class="auto-style18">
                                    <asp:Label ID="lblGender" runat="server" Width="284px"></asp:Label></td>
                                  <td class="auto-style23">婚姻狀況:</td>
                                <td class="auto-style19">
                                    <asp:Label ID="lblMarriage" runat="server" Width="300px"></asp:Label></td>
                             ...
                             <tr>
                                 <td class="auto-style23">籍&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;貫:</td>
                                <td class="auto-style18">
                                    <asp:Label ID="lblProvince" runat="server" Width="283px"></asp:Label></td>
                                <td class="auto-style23">國&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;籍:</td>
                                <td class="auto-style19">
                                    <asp:Label ID="lblCountry" runat="server" Width="300px"></asp:Label></td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style23">身&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;高:</td>
                                <td class="auto-style18">
                                    <asp:Label ID="lblStature" runat="server" Width="275px"></asp:Label></td>
                                <td class="auto-style23">體&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;重:</td>
                                <td class="auto-style19">
                                    <asp:Label ID="lblWeight" runat="server" Width="300px"></asp:Label></td>
                            </tr>
                   
                              <tr>
                                <td class="auto-style23">身份證號:</td>
                                <td colspan="4">
                                    <asp:Label ID="lblIdentityNo" runat="server" ></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="auto-style23">電子郵件:</td>
                                <td colspan="4">
                                    <asp:Label ID="lblEmail" runat="server" ></asp:Label></td>
                            </tr>
                              <tr>
                                <td class="auto-style23">現在住址:</td>
                                <td colspan="4">
                                    <asp:Label ID="lblNowAddress" runat="server" ></asp:Label></td>
                            </tr>
                              <tr>
                                <td class="auto-style23">戶籍住址:</td>
                                <td colspan="4">
                ...
                <div>
                    ...
                    <div style="text-align: end; margin-right: 60px;">表單文號: 1H4-012&nbsp;&nbsp;REV:1</div>
                </div>
            </div>
        </div>
    </form>
