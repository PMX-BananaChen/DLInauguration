...
{
    public partial class InaugrationRecords_IDL : System.Web.UI.Page
    {
        string f_startDay = "";
        string f_endDay = "";
        string f_name = "";
        ...
        private void SeachData(string startDay, string endDay, string idNo, string name, string area,string titleid, int pageSize, int currentPage)
        {
            ...
            {
                this.rptInauRecords.DataSource = dsInauguration.Tables[2];
                ...
                DataTable dtRecord = dsInauguration.Tables[3];
        ...
        private void GetData(int page)
        {
            ...
            {
                titleid = Request.QueryString["titleid"].Trim();
            } 
            pageSize = 50;
            f_startDay = startDay;
            f_endDay = endDay;
        ...
        public string GetDetailURL(object idObj)
        {
            ...
            string url = "../IDL/InaugurationDetail_IDL.aspx?ID=" + id;
            return url;
        }
        ...
        {
            string id = idObj.ToString();
            string url = "../IDL/InaugurationDetailVaccine_IDL.aspx?ID=" + id;
            return url;
        }
        ...
        {
            string id = idObj.ToString();
            string url = "../RegisterIDL.html?ID=" + id;
            return url;
        }
        ...
        protected void btnBatchPrint_Click(object sender, EventArgs e)
        {
            ...
            //  int currentPage = Convert.ToInt32(this.lblCurrPage.Text);
            //   GetData(currentPage);
            Response.Write("<script>window.open('BatchPrint_IDL.aspx','_blank')</script>");
        }
    }
}