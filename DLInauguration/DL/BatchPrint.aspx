<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchPrint.aspx.cs" Inherits="DLInauguration.DL.BatchPrint" %>
                            ...
                            <fieldset style="margin-left: 60px;">
                                ...
                                <table style="width: 90%; margin-left: 30px; line-height: 30px;" border="0">
                                    <tr style="border: 0;">
                                        ...
                                        <td style="text-align: left; width: 20%; border: solid 1px #cbcbcb;">工號：<asp:Label ID="lblEmpNo" runat="server" Width="147px"></asp:Label></td>
                                    </tr>
                                </table>
                            </fieldset>
                        </div>
                        ...
                        <div>
                            ...
                            <fieldset style="margin-left: 60px;">
                                ...
                                <table class="tablelist">
                                    ...
                                    <tr>
                                        <td style="width: 25%;">
                                            <asp:Label ID="lblIsReligiousBelief" runat="server"></asp:Label>
                                        </td>
                                        <td style="width: 75%;">
                                            <asp:Label ID="lblReligiousBelief" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
